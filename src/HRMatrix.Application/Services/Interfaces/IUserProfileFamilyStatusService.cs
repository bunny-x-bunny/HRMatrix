...
public interface IUserProfileFamilyStatusService {
    ...
    Task<bool> UpdateFamilyStatusForUserProfileAsync(UpdateFamilyStatusDto familyStatusDto, UserProfile user, bool withSave = false);
    Task<bool> DeleteFamilyStatusForUserProfileAsync(UserProfile user, bool withSave = false);
}