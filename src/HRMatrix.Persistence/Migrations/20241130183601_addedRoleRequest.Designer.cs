...
namespace HRMatrix.Persistence.Migrations
{
    ...
    [Migration("20241130183601_addedRoleRequest")]
    partial class addedRoleRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.CityTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.CountryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.OrderReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.OrderWorkType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.UserProfileWorkType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserProfileWorkTypes");
                });
            ...
            modelBuilder.Entity("HRMatrix.IdentityService.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7857895f-eaa0-4253-8689-51fc02bd4863",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEDRCPp/8Vk9z/c7hKzn8UiMUpJZNkL2S3s2nVaHPJrAKrPrYDqqKM1EGK4Yu4u+HSw==",
                            PhoneNumber = "1234567890",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "8cef086e-4ce1-4b2e-b208-eb411bb4d3eb",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "249b0dda-a58a-41a8-8390-126d26966d7a",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHrO2amjAR3OtCW+3FoA6mxwB21Jcjkhfz6DrafLFLdtF6OrzYqEOsk4i96CJ2QCNg==",
                            PhoneNumber = "0987654321",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "5141792e-aa97-4ba2-b79e-0f9bb09ac234",
                            TwoFactorEnabled = false,
                            UserName = "superuser"
                        },
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5710fd6f-c60b-4272-bd70-8c4fe07ab9a6",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEH5WMv93YLDa7ocLCyMXKDRRS1nXWnCrDZGTZeaibFJe4bJbTH00OqHEfUE0nmnEDw==",
                            PhoneNumber = "5551234567",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "f4227d0f-ed5d-4f95-ac9b-22be1c451078",
                            TwoFactorEnabled = false,
                            UserName = "hr"
                        },
                        new
                        {
                            Id = 4,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "549a7034-9384-41ce-95db-f3e9385ca46e",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEY46vexG5l/OeMTxmBkdXlieQ/iqg5nmUAk1bQWIEMTVXYZ31prS0fEAsLeSX8Vbg==",
                            PhoneNumber = "5559876543",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "18c68d0e-5651-44f6-98a2-bac886b6aa88",
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("HRMatrix.IdentityService.Models.RoleRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.City", b =>
                {
                    b.HasOne("HRMatrix.Domain.Entities.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("HRMatrix.IdentityService.Models.RoleRequest", b =>
                {
                    b.HasOne("HRMatrix.IdentityService.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.Order", b =>
                {
                    b.Navigation("OrderResponses");

                    b.Navigation("OrderSkills");

                    b.Navigation("OrderWorkTypes");
                });
            ...
            modelBuilder.Entity("HRMatrix.Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Navigation("UserProfileWorkTypes");
